...
# "codereeve.after_run._current_labels" wholesale and import it
...
# (src/codereeve/hooks/force_pr_not_merge.py) when a worker attempts to
...
def _classify() -> RunOutcome:
    ...
    # See src/codereeve/hooks/force_pr_not_merge.py.
