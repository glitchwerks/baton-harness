...
from codereeve.chain import app_auth, ruleset_status, sandbox_config
...
def _check_package_entry_points(ctx: DoctorContext) -> CheckResult:
    ...
    installed = {
        entry_point.name
        for entry_point in metadata.distribution("codereeve").entry_points
...
def _check_package_workflow(ctx: DoctorContext) -> CheckResult:
    ...
    """
    del ctx
    from codereeve.chain.cli import _workflow_path
