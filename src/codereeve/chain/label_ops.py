...
``daemon.py`` does
``from codereeve.chain.label_ops import fetch_daemon_labels as
...
from codereeve._cli import err
...
def fetch_daemon_labels(
    ...
    *,
    ...
    from codereeve.chain import daemon as _daemon_mod
...
def fetch_after_run_labels(issue: int) -> list[str] | None:
    ...
    from codereeve import after_run as _after_run_mod
