...
- During the day: unavailable. No interruptions, no approvals, no mid-run decisions.
...
- Not fully autonomous end-to-end. Human approval is required at both ends of every work unit.
...
- No action is required from me between kickoff and review.
