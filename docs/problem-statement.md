...
- During the day: minimally available. The system may surface threshold-crossing questions via Slack and wait for async guidance; it must not surface every minor question. [decided — not yet built]
...
**Mid-run escalation — answered async by me [decided — not yet built]**
...
- Not fully autonomous end-to-end. Human approval is required at both ends of every work unit, with minimal async guidance on threshold-crossing questions the system escalates during a run. [decided — not yet built]
...
- No action is required from me between kickoff and review, beyond answering the rare, threshold-crossing questions the system escalates. [decided — not yet built]
